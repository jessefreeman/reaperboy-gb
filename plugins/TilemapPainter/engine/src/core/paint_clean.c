...
//
// The implementation was previously in a single monolithic file, but
// has been refactored into smaller, more maintainable modules with
// clear responsibilities.
//
// See the header files for each module to understand their public interfaces.

// No actual code in this file - it's just a compatibility stub
// All functionality has been moved to the separate modules imported above
